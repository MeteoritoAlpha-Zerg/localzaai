...
async def test_project_enumeration_options(zerg_state=None):
    """Test CloudWatch project enumeration by way of query target options"""
    ...
    print(f"cloudwatch query target option definitions: {query_target_options.definitions}")
    print(f"cloudwatch query target option selectors: {query_target_options.selectors}")
