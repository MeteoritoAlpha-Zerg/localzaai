...
class LoggingHelperTest(unittest.TestCase):
    ...
    def test_escaping(self):
        ...
        assert (
            log["message"]
            == "I'm testing the \\\"escaping\\\" of 'quotes' and \\\\backslashes\\\\"
        )
    ...
    def test_logging_json(self):
        ...
        log = json.loads(log_output.getvalue())
        assert (
            "Error parsing JSON response from LLM. Response was \\n" in log["message"]
        )
    ...
    def test_exception(self):
        ...
        assert (
            log["message"] == "An exception was encountered: This is a test exception"
        )
