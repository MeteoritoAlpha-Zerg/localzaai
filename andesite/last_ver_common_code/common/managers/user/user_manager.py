...
class UsersManager:
    _col: Optional[AsyncIOMotorCollection]
    ...
    @classmethod
    @check_client_initialization
    async def get_or_create_user_from_email(cls, user_email: Optional[str]) -> str:
        """
    ...
    @classmethod
    @check_client_initialization
    async def update_user(cls, user_id: str, values: dict[str, Any]) -> Optional[User]:
        """
