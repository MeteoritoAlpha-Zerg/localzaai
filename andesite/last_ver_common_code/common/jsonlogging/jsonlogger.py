    ...
    def format(self, record):
        try:
            ...
            record.event_data = json.dumps(
                record.event_data, default=lambda o: getattr(o, "__dict__", str(o))
            )
...
def _get_json_logger(name: str, level: Union[str, int]) -> logging.Logger:
...
class Logging:
    ...
    @classmethod
    def initialize(cls, level: Union[str, int]):
        cls.level = level
