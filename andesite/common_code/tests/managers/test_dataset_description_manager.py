...
async def test_dataset_description_not_exist(
    ...
    descriptions = await dataset_description_manager.get_dataset_descriptions_async(connector="nonexistent")
...
async def test_set_dataset_description(
    ...
    new_dataset_description = await dataset_description_manager.set_dataset_description_async(dataset_description)

    assert new_dataset_description.description == dataset_description.description

    # Check setting same dataset description
    new_dataset_description = await dataset_description_manager.set_dataset_description_async(
        dataset_description.model_copy()
    )
    assert new_dataset_description.description == dataset_description.description

    dataset_descriptons = await dataset_description_manager.get_dataset_descriptions_async(connector)
...
async def test_delete_dataset_description(
    ...
    dataset_descriptions = await dataset_description_manager.get_dataset_descriptions_async(connector)
