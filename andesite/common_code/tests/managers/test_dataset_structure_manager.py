...
async def test_dataset_structure_not_exist(
    ...
    ds = await dataset_structure_manager.get_dataset_structure_async("nonexistent", "nonexistent")
    assert ds is None
...
async def test_get_all_dataset_structures(
    ...
    dataset_structure = DatasetStructure(connector=connector, dataset=dataset, attributes="test attributes")
...
async def test_set_dataset_structure(dataset_structure_manager) -> None:
    ...
    dataset = "test_dataset"
    dataset_structure = DatasetStructure(connector=connector, dataset=dataset, attributes="test attributes")
    new_dataset_structure = await dataset_structure_manager.set_dataset_structure_async(dataset_structure)

    assert new_dataset_structure.attributes == dataset_structure.attributes

    # Check setting same dataset structure
    new_dataset_structure = await dataset_structure_manager.set_dataset_structure_async(dataset_structure.model_copy())
    assert new_dataset_structure.attributes == dataset_structure.attributes

    dataset_structure = await dataset_structure_manager.get_dataset_structure_async(connector, dataset)
...
async def test_delete_dataset_structure(dataset_structure_manager) -> None:
    connector = "test_connector"
    dataset = "test_dataset"
    dataset_structure = DatasetStructure(connector=connector, dataset=dataset, attributes="test structure")
    new_dataset_structure = await dataset_structure_manager.set_dataset_structure_async(dataset_structure)

    assert new_dataset_structure.attributes == dataset_structure.attributes

    # Check setting same dataset structure
    new_dataset_structure = await dataset_structure_manager.delete_dataset_structures_async(
        dataset_structure.connector, [dataset_structure.dataset]
    )

    assert await dataset_structure_manager.get_dataset_structure_async(connector, dataset) is None
